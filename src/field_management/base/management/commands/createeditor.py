...
from base.choices import EDITOR
    ...
    def handle(self, *args, **options):
        ...
        if username:
            ...
            if options['verbosity'] >= 1:
                ...
                user_create.first().groups.add(Group.objects.get(name='editor'))

                # Option supereditor
                op = Option.objects.filter(user_id=user_create.first().id)
                op.update(option=EDITOR)

                self.stdout.write("Editor created successfully.")
